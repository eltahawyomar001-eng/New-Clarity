// High-quality SVG icons for NewClarity - No emojis
export const Icons = {
  // Navigation
  ...
  RocketLaunch: ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  Quote: ({ className = "w-6 h-6" }: { className?: string }) => (
  ...
  Logo: ({ className = "w-8 h-8" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      ...
      />
      <path
        d="M16 20C16 17.7909 17.7909 16 20 16C22.2091 16 24 17.7909 24 20C24 22.2091 22.2091 24 20 24"
        stroke="url(#logoGradient)"
        strokeWidth="2"
        strokeLinecap="round"
      />
  ...
  // Decorative
  GridDots: ({ className = "w-full h-full" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 100 100" fill="none">
      <pattern id="gridDots" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
  ...
  CircleGlow: ({ className = "w-full h-full" }: { className?: string }) => (
